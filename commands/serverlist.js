...
module.exports = {
  info: {
    name: "serverlist",
    description: "you cant use developer commands",
    usage: "",
    aliases: ["sl"],
  },
   ...
   run: async (bot, message, args) => {
    if (message.author.id == ownerid) {
       if (message.author.id !== `525675076155080704`) return message.reply('```bash\n"❌ Only the bot creator can use this command!"```')
      ...
      let embed = new Discord.MessageEmbed()
        ...
        .setColor("00FFFF")
        .setFooter(`Page - ${page}/${Math.ceil(bot.guilds.cache.size / 10)}, Coded by TOM WNL#8625`)
